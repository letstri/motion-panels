...
Folding, collapsing, pinning, nesting, reordering, separator intersections, keyboard and RTL support, plus the framework-agnostic core API — all with live demos:
